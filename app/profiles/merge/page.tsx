  ...
  return (
    <section className="space-y-8">
      ...
      <section className="space-y-5 rounded border border-line bg-white p-6">
        <h2 className="text-xl font-semibold text-ink">Profile Selection</h2>
        <div className="grid gap-5 md:grid-cols-2">
          <SearchableProfileSelector
            label="Primary profile to keep"
            selectedProfile={primaryProfile}
            onSelect={handlePrimarySelect}
          />
          <SearchableProfileSelector
            label="Duplicate profile to merge"
      ...
      {preview ? (
        <section className="space-y-5 rounded border border-line bg-white p-6">
          <h2 className="text-xl font-semibold text-ink">Merge Preview</h2>
          ...
          <div className="space-y-3 border-t border-line pt-5">
            <label className="flex items-start gap-2 text-sm text-neutral-700">
              <input
                ...
                className="mt-1"
              />
              I reviewed this preview and understand the duplicate profile will
              be marked as merged.
            </label>
            <button
              type="button"
...
function ProfilePairSummary({ preview }: { preview: MergePreview }) {
  return (
    <div className="grid gap-4 md:grid-cols-2">
      <ProfileSummaryCard label="Primary profile" profile={preview.primaryProfile} />
      <ProfileSummaryCard
        ...
        <ul className="space-y-2">
          {fields.map((field) => (
            ...
            >
              ...
              : primary {formatValue(field.primaryValue)} | duplicate{" "}
